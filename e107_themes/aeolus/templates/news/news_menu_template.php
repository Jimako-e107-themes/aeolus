...
// category menu
$NEWS_MENU_TEMPLATE['category']['start']       = '<div class="list-style"><div class="list-style-nine"><ul>';
$NEWS_MENU_TEMPLATE['category']['end']         = '</ul></div><div>';
$NEWS_MENU_TEMPLATE['category']['item']        = '
	...
	<span><i class="lni lni-arrow-right"></i>{NEWS_CATEGORY_TITLE}</span><span class="badge bg-primary rounded-pill">{NEWS_CATEGORY_NEWS_COUNT=raw}</span></a></li>
';
