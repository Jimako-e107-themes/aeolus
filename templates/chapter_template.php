...
$CHAPTER_TEMPLATE['book-menus']['listItems']['caption']		= ''; 
$CHAPTER_TEMPLATE['book-menus']['listItems']['start'] 			= '{SETSTYLE=none}'; 
$CHAPTER_TEMPLATE['book-menus']['listItems']['item'] 	= 'xxx'; 
$CHAPTER_TEMPLATE['book-menus']['listItems']['end'] 					= '</div>';	
